...
export const LOAD_ALERT_THRESHOLD = 1; //cpu load considered high load
export const LOAD_ALERT_WINDOW = 120000; //milliseconds for time of cpu usage above threshold to be considered an alert

export const LOAD_ALERT_RECOVERY_THRESHOLD = 1; //cpu load considered high load
...
export const MIN_LOG_ALERT_LENGTH = Math.max(LOAD_ALERT_WINDOW / POLLING_INTERVAL, 5); //minimum log length for potential load alerts. Always bigger than 10 entries.
